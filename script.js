const ASSETS = {
  ...
  for(var i in ITEMS){
              ...
              data += 
              '<div class="items">'+
              '<img src= '+ITEMS[i].image+'" class="card-img-top" alt='+ITEMS[i].title+' width="200" height="200">' + 
             
              '<h5 class="title"> '+ITEMS[i].title+' </h5>' +
              '<p class="price">$'+ITEMS[i].price+'.00 </p>'+
             
          '</div>'
             
          }
   document.querySelector(".item-container").innerHTML = data;
